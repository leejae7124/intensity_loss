    ...
    arguments = {
        ...
        'paths': [
            dict(name='--resnet101_pretrained',
                 default='/home/leessu/code/VAANet/resnet-101-kinetics.pth',
                 type=str,
                 help='Global path of pretrained 3d resnet101 model (.pth)'),
            dict(name='--root_path',
                 default="./tools/annotations/ve8",
                 type=str,
                 help='Global path of root directory'),
            dict(name="--video_path",
                 default="/home/leessu/code/VAANet/tools/annotations/ve8/VideoEmotion8--imgs",
                 type=str,
                 help='Local path of videos', ),
            dict(name="--annotation_path",
                 default='/home/leessu/code/VAANet/tools/annotations/ve8/ve8_05.json',
                 type=str,
            ...
            dict(name='--saliency_path',
                 default="/home/leessu/code/VAANet/tools/annotations/ve8/VideoEmotion8--saliency",
                 type=str,
            ...
            dict(name='--audio_path',
                 type=str,
                 default='/home/leessu/code/VAANet/tools/annotations/ve8/VideoEmotion8--mp3',
